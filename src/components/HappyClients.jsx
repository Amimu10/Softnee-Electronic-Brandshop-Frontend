    ...
    <div data-aos="zoom-out-left" className="py-5 max-w-[1340px] lg:px-8 px-4 mx-auto">
      <div className="mb-8 text-center mt-12">
        ...
        <p className="md:text-lg text-base font-young font-medium text-[#555]">
          ...
          explorer, or someone in search of the latest innovations, Softonne
          ensures a seamless and enjoyable shopping journey. Explore our range
          of products, read helpful reviews, and make your tech dreams a reality
          with Softonne.
        </p>
      </div>
          ...
          <div key={index} className="p-4">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="leading-relaxed text-sm text-gray-500\ mb-3 font-young">
                  {testimonial.quote}
                </p>
                  ...
                  <div className="flex">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <FaStar
                        key={i}
                        className={`text-${
                          i < testimonial.stars ? "[#f33f3f]" : "gray"
                        }`}
                      />
                    ))}
                    {testimonial.stars % 1 !== 0 && (
                      <FaStarHalfAlt className="text-[#f33f3f]" />
                    )}
                  </div>
                </div>
              </div>
